...
public class ZombieAnimation extends Pane{
    ...
    public void setZombieMode(int zombieMode){
        this.zombieMode = zombieMode;
    }

    private void setClothesMode(boolean flag, Clothes clothes){
        if(flag){
            clothes.setMode(zombieMode);
        }
    }

    public void setHat(Hat hat){
        this.hat = hat;
        hat.setMode(zombieMode);
    ...
    public void walkDown(){
        zombieMode = WALK_DOWN;
        start();
    }

    public void walkwoodUp(){
        zombieMode = WALKWOOD_UP;
        start();
    }

    public void walkwoodDown(){
        zombieMode = WALKWOOD_DOWN;
        start();
    }
    ...
    public void start(){
        zombie = zombieAnimations[zombieMode];
